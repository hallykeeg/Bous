 ...
 * Use the {@link FragmentDepense#newInstance} factory method to
...
public class FragmentDepense extends Fragment {
     ...
     * @return A new instance of fragment FragmentDepense.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentDepense newInstance(String param1, String param2) {
        FragmentDepense fragment = new FragmentDepense();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fabNouveau.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new FragmentAjoutDepenses()).commit();
            }
        });
